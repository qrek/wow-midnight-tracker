...
const rp = (m40, h40, n40, m41, h41, n41, m42, h42, n42) => ({
  40: { mythic: { killed: m40, total: 6 }, heroic: { killed: h40, total: 6 }, normal: { killed: n40, total: 6 } },
  41: { mythic: { killed: m41, total: 1 }, heroic: { killed: h41, total: 1 }, normal: { killed: n41, total: 1 } },
  42: { mythic: { killed: m42, total: 2 }, heroic: { killed: h42, total: 2 }, normal: { killed: n42, total: 2 } },
})
...
export const MOCK_GUILD = {
  ...
  members: [
    // ─── Tanks ───────────────────────────────────────────────────────────────
    {
      ...
      raidProgress: rp(3, 5, 6, 0, 1, 1, 0, 0, 0),
    ...
    },
    {
      ...
      raidProgress: rp(2, 5, 6, 0, 1, 1, 0, 0, 0),
    ...
    },
    {
      ...
      raidProgress: rp(2, 4, 6, 0, 0, 1, 0, 0, 0),
    ...
    // ─── DPS ──────────────────────────────────────────────────────────────────
    {
      ...
      raidProgress: rp(4, 6, 6, 1, 1, 1, 0, 0, 0),
    ...
    },
    {
      ...
      weeklyKey: { dungeon: 'Pit of Saron', level: 16, inTime: false },
      raidProgress: rp(2, 4, 6, 0, 1, 1, 0, 0, 0),
