...
const DUNGEONS = [
  {
    ...
    description: "Sanctuaire des Arakkoa perché dans les nuages de Draenor, l'Orée-du-Ciel abrite des fanatiques du soleil. Ce retour en Mythique+ exige une gestion précise des tornades, des chakrams et des ajouts.",
    timer: "35 min",
    bosses: [
      {
        name: "Ranjit",
  ...
  },
  {
    ...
    description: "Situé dans Mac'Aree sur la planète Argus, le Siège du Triumvirat abrite des créatures corrompues par le Vide. Gestion des tentacules, créatures du Vide et coopération d'équipe sont essentielles.",
    timer: "33 min",
    bosses: [
      {
      ...
      },
      {
        ...
        mechanics: [
          ...
          { name: "Bond de l'Ombre", type: "heal", desc: "Dégâts sur cible aléatoire — dispellez le saignement ou utilisez un défensif." },
  ...
  },
  {
    ...
    description: "École de magie draconique dans les Îles des Dragons, l'Académie d'Algeth'ar mêle mécaniques de boss complexes et gestion d'adds. Interruptions, dispels et positionnement de groupe sont clés.",
    timer: "35 min",
    bosses: [
      {
        name: "Ancien Envahi",
  ...
  },
  {
    ...
    description: "Ancienne mine glaciale de la Couronne de Glace, la Fosse de Saron est de retour en Mythique+. Ce donjon exige une maîtrise rigoureuse des mécaniques de glace, de ligne de vue et de gestion des adds du Fléau.",
    timer: "33 min",
    bosses: [
      {
  ...
  },
  {
    ...
    description: "Ancienne citadelle Sanssoif entièrement redessinée pour Midnight, la Terrasse des Magistères propose de nouveaux boss et mécaniques arcaniques dans les Bois de Chantevent. Minuterie de 33 minutes.",
    timer: "33 min",
    bosses: [
      {
  ...
  },
  {
    ...
    description: "Au coeur des Bois de Chantevent, la Flèche de Coursevent est un mémorial à la tragique histoire de la famille Coursevent — Alleria, Vereesa, Sylvanas et Lyrath. Ce donjon exige précision dans les interruptions et le positionnement.",
    timer: "36 min",
    bosses: [
      {
        name: "Emberdawn",
        ...
        mechanics: [
          ...
          { name: "Courant Ascendant Enflammé", type: "dodge", desc: "Debuff sur 2 joueurs qui explose après 6 sec — éloignez-vous des autres avant l'explosion." },
      ...
      },
      {
        ...
        mechanics: [
          ...
          { name: "Mort Simultanée", type: "tip", desc: "Les deux boss doivent mourir quasi-simultanément pour éviter l'enrage Lien Brisé." },
        ],
      },
      {
        ...
        role: "3ème boss",
        mechanics: [
          { name: "Bond Téméraire", type: "dodge", desc: "Grand AoE + DoT sur la cible la plus éloignée — stackez les mêlées, désignez un point pour les distanciers." },
      ...
      },
      {
        ...
        mechanics: [
          ...
          { name: "Pluie de Flèches", type: "dodge", desc: "Crée des cercles à esquiver — servent ensuite à retirer le DoT." },
          { name: "Tir à la Rafale", type: "dodge", desc: "AoE retirant les flaques et appliquant un DoT." },
  ...
  },
  {
    ...
    description: "Divisé en trois ailes représentant les magies Arcanique, du Vide et de la Lumière, le Point-Nexus Xenas est situé dans la zone de la Tempête du Vide. Le donjon le plus exigeant conceptuellement de la saison.",
    timer: "38 min",
    bosses: [
      {
      ...
      },
      {
        ...
        role: "2ème boss",
        mechanics: [
          { name: "Éclat de Lumière", type: "cooldown", desc: "Le boss gagne +300% dégâts et +30% soins — gardez vos cooldowns pour cette phase (~30 sec, puis toutes les 60 sec)." },
  ...
  },
  {
    ...
    description: "Le donjon le plus complexe de la rotation Midnight avec seulement 3 boss aux mécaniques très élaborées. Excellente coordination d'interruptions, positionnement précis et gestion fine des cooldowns sont indispensables.",
    timer: "34 min",
    bosses: [
      {
        ...
        role: "1er boss",
        mechanics: [
          { name: "Mort Simultanée", type: "tip", desc: "Les deux boss doivent mourir quasi-simultanément — équilibrez les DPS à ~15% pour l'exécution finale." },
      ...
      },
      {
        ...
        mechanics: [
          ...
          { name: "Convergence Nécrotique", type: "cooldown", desc: "Canal bouclié avec dégâts AoE croissants — brisez le bouclier en priorité absolue avant saturation." },
  ...
  return (
    <div className="min-h-screen bg-void-950 text-void-100">
      <div className="border-b border-void-800 bg-void-900/50 px-8 py-6">
        ...
        <p className="text-void-400 text-sm mt-1">Saison 1 · 8 donjons · Guides boss &amp; mécaniques</p>
      </div>
              ...
              <div className="flex gap-1">
                {dungeon.bosses.map((b, i) => (
                  <div
                    ...
                    style={{ backgroundColor: dungeon.color, opacity: 0.4 + i * 0.15 }}
                    title={b.name}
                  />
                ))}
              </div>
              <span className="text-xs text-void-500">{dungeon.bosses.length} boss</span>
            </div>
          </div>
